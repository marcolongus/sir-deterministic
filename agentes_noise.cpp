...
int main(void) {
	...
	seed_space = 2956358276;
	seed_sir = 2956358376;
	// Good seed for testing
	// seed_space: 3020257152
	// seed_sir  : 3020257252
	...
	uniform_int_distribution<> dist(2, 99); // Define the range
	...
	for (int simulation=0; simulation<30; simulation++) {
	    ...
	    n_inmunes = simulation;
	    if (simulation > 0) n_realization = 50;

	    for (int n_simul=0; n_simul < n_realization; n_simul++) {
	    	int start_s=clock();
		    ...
		    //=======================================================================/
		    // Setting immune particles
		    //=======================================================================/
		    cout << "Immune particles list:" << endl;
		    forn (i, 0, n_inmunes) {
		    	bool inmune_accepted = false;
		    	int particle_id = 0;
		    	while (!inmune_accepted) {
		    		particle_id = dist(gen);
		    		if (!system[particle_id].is_inmune()) { 
		    			system[particle_id].set_inmune();
		    			inmune_accepted = true;
		    		}
		    	}
		    	cout << i << ". " <<   particle_id << " ";
		    	cout << system[particle_id].velocity << endl;
		    }
		    cout << endl;
		    ...
		    states << time   		 << " " << simulation << endl;

		    pico   << i_max  		 << " ";
		    pico   << t_imax 		 << endl;

			/*=======================================================================================*/
		    /*Escritura de Resultados en pantalla 													 */
			/*=======================================================================================*/
